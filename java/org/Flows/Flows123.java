...
public class Flows123 extends BaseClass{
	...
	@Test
	public void A_loginpage () throws InterruptedException, AWTException, IOException {
		...
		user.click();
		Thread.sleep(1000);
		user.sendKeys("KBZPayCenter@gmail.com");
		...
		WebElement password = driver.findElement(By.xpath("//*[@id='flt-semantic-node-15']/following::flt-semantics[@aria-label='Enter Password']//input[1]"));
		password.sendKeys("9gU#1DJC5JFqxSRgPYVE");
